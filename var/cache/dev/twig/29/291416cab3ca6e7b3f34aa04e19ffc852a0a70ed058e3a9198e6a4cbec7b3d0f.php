...
class __TwigTemplate_dcd3446f1b424a314aaf8a2bf10d87e36e06e505ad237ebb0d90a933f704edd3 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        ...
        echo "\">Pas de compte ? Inscrit toi !</a>
</form>
";
    ...
    {
        return array (  132 => 22,  127 => 20,  123 => 19,  118 => 17,  115 => 16,  107 => 13,  104 => 12,  102 => 11,  99 => 10,  95 => 8,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form class=\"formulaire\" action=\"{{ path('connexion')}}\" method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            You are logged in as {{ app.user.username }}, <a href=\"{{ path('deconnexion') }}\">Logout</a>
        </div>
    {% endif %}
    <h1>Connexion</h1>
    ...
    <a href=\"{{path('mdpOublie')}}\">Mot de passe oublié </a>
    <input type=\"submit\" id='submit' value='LOGIN'>
    <a href=\"{{path('inscription')}}\">Pas de compte ? Inscrit toi !</a>
</form>
{% endblock %}
", "security/login.html.twig", "/Users/laura/Desktop/wishlist/templates/security/login.html.twig");
    }
}
