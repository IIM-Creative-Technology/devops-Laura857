...
class __TwigTemplate_a8c77b214b715f8f4ae68add5026d1339cf4fc94b87654cafab41438851b8226 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
            // line 14
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), "password", [], "any", false, false, false, 14), "second", [], "any", false, false, false, 14), 'row');
            echo "
\t\t\t\t
\t\t\t</div>
...
\t";
    ...
    {
        return array (  101 => 22,  90 => 14,  85 => 12,  80 => 10,  73 => 5,  71 => 4,  68 => 3,  58 => 2,  35 => 1,);
    }
