...
class __TwigTemplate_dd6301026b2b858023fff5364f348fad24ecc360c55a3fb50f77d1b8a3f23567 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      ";
        ...
        <div class=\"row justify-content-md-center\">
          <div class = \"col-sm-6 control-label\">
            ";
        // line 35
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 35, $this->source); })()), "password", [], "any", false, false, false, 35), 'row', ["label" => "Mot de passe (6 caractères minimum):", "attr" => ["placeholder" => "mot de passe"]]);
        echo "
          </div>
        </div>
        <div class=\"row justify-content-md-center\">
  ...
  <div class = \"container\">
    ...
    <div class = \"form_horizontal\">
      {{ form_start(form) }}
        ...
        <div class=\"row justify-content-md-center\">
          <div class = \"col-sm-6 control-label\">
            {{ form_row(form.password, {'label': 'Mot de passe (6 caractères minimum):', 'attr':{'placeholder': 'mot de passe'}}) }}
          </div>
        </div>
        <div class=\"row justify-content-md-center\">
          <div class = \"col-sm-6 control-label\">
