...
class __TwigTemplate_e7783a01062e32c7f235e52a04bb8df01ba32b687445534446aeb4fd0e7792f1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        // line 20
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["our_form"]) || array_key_exists("our_form", $context) ? $context["our_form"] : (function () { throw new RuntimeError('Variable "our_form" does not exist.', 20, $this->source); })()), "name", [], "any", false, false, false, 20), 'row', ["attr" => ["placeholder" => "nom", "autofocus" => "true"]]);
        echo "
\t\t\t\t";
        // line 21
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["our_form"]) || array_key_exists("our_form", $context) ? $context["our_form"] : (function () { throw new RuntimeError('Variable "our_form" does not exist.', 21, $this->source); })()), "email", [], "any", false, false, false, 21), 'row', ["attr" => ["placeholder" => "email"]]);
        echo "
\t\t\t\t";
        // line 22
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["our_form"]) || array_key_exists("our_form", $context) ? $context["our_form"] : (function () { throw new RuntimeError('Variable "our_form" does not exist.', 22, $this->source); })()), "texte", [], "any", false, false, false, 22), 'row', ["attr" => ["placeholder" => "message"]]);
        echo "
...
\t\t\t";
        // line 26
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["our_form"]) || array_key_exists("our_form", $context) ? $context["our_form"] : (function () { throw new RuntimeError('Variable "our_form" does not exist.', 26, $this->source); })()), 'form_end');
        echo "
\t\t\t
\t\t\t<p style=\"text-align:center; margin-top:10px\">Vous pouvez également nous contacter directement par mail en cliquant
...
";
    ...
    {
        return array (  107 => 26,  100 => 22,  96 => 21,  92 => 20,  88 => 19,  71 => 4,  61 => 3,  50 => 1,  48 => 2,  35 => 1,);
    }
...
\t\t\t<div class=\"form-group\" style=\"margin-top:20px\">
\t\t\t{{ form_start(our_form) }}
\t\t\t\t{{ form_row(our_form.name, {'attr':{'placeholder': 'nom', 'autofocus': 'true'}}) }}
\t\t\t\t{{ form_row(our_form.email, {'attr':{'placeholder': 'email'}}) }}
\t\t\t\t{{ form_row(our_form.texte, {'attr':{'placeholder': 'message'}}) }}
\t\t\t\t<button type=\"submit\" class=\"btn btn-dark btn-lg btn-block\">
\t\t\t\t\tValider
\t\t\t\t</button>
\t\t\t{{ form_end(our_form) }}
