...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getWishlistControllerService()
    {
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'session' => '?',
            'twig' => '?',
        ]))->withContext('App\\Controller\\WishlistController', $this));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'mysql', 'charset' => 'utf8mb4', 'host' => 'localhost', 'unix_socket' => '/Applications/MAMP/tmp/mysql/mysql.sock.lock', 'port' => $this->getEnv('DATABASE_PORT'), 'user' => $this->getEnv('DATABASE_USERNAME'), 'password' => $this->getEnv('DATABASE_PASSWORD'), 'url' => $this->getEnv('resolve:DATABASE_URL'), 'driverOptions' => [], 'serverVersion' => '5.7', 'defaultTableOptions' => []], $a, $d, []);
    }
